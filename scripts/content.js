...
function saveProfile(){
  var text2 = document.getElementById('atef');
    console.log(text2)
 ...
 // document.getElementById("pro").innerHTML=fullName
 ...
 // console.log(window.location.href)
      ...
      // document.getElementById("pro").innerHTML=profileData[0].fullName
     // sessionStorage.setItem("mykey","profileData");
      //let list =document.querySelector("#list")
      //let button =document.querySelector("button")
     // let arrayValue = JSON.parse(localStorage.getItem("Fruit")) || []
      // arrayValue =  profileData
   /*   button.addEventListener("click", function(){
        let userInput= document.querySelector("#input").value*/
      
      // localStorage.setItem("Fruit", JSON.stringify(profileData))
    ...
    m=profileData
   console.log(m)
//localStorage.setItem("taha", JSON.stringify(m))
/*  document.getElementById('pr').onclick=function(){
  sessionStorage.setItem('TheArray', JSON.stringify(m))
  window.location.href ='http://localhost:3000/63318c04f122ba097253f290/edit';*/
// }
//document.cookie = ' array ,JSON.stringify(m)'
  ...
  function messageHandler(event) {
    ...
    if (action == 'save'){
      ...
      event.source.postMessage({
       // action: 'returnData', key, JSON.parse(window.localStorage.getItem(key))
      }, '*')
    }
  }
...
function main() {
    ...
    <div id=''>\
    <label id='' for='deepscan'><label type='' name='deepscan' id='deepscan' value=''/></label>\
    </div>\
    </div>\
    <br/>\
    \
    \
    <div class='internal_button' id='certification_extract_button'>Extract </div>\
    ...
    <br/>\
    <br/>\
    <textarea type='text' id='objectvalue'></textarea>\
    <br/>\
...
/*  if(window.location.href==="https://www.linkedin.com/in/nada-atef-a59b4320b/"){
    m=profileData
        console.log(m)
  //document.getElementById("pro").innerHTML= profileData*
}
else{
  console.log(m)
...
// document.getElementById("divMsg").innerHTML = profileData.fullName
...
//////// * ----- UTILS ENDS -------* /////////
 function passvalues(){
  var firstname =document.getElementById("sbodycontainer").value;
...
fetch('http://localhost:5000/Users/newUser',data, 
{
  method: 'POST', 
  headers: {
